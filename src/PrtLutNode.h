...
public:    
  ...
  // Modifiers
  void AddEntry(Int_t nodeId, TVector3 dir, Double_t pathid, Int_t nrefl, Double_t time, TVector3 hitpos, TVector3 hitposGlobal, TVector3 digipos,  Double_t weight=1);
  void AddEntry(Int_t nodeId, TVector3 dir, Double_t pathid, Int_t nrefl, Double_t time, TVector3 hitpos, TVector3 hitposGlobal, TVector3 digipos,  Double_t weight,
  ...
  TVector3 GetHitPosGlobal(Int_t entry){ return fHitPosGlobal[entry]; }
  TVector3 GetDigiPos(Int_t entry){ return fDigiPos[entry]; }
